...
(function () {
  ...
  function buildSidebar() {
    ...
    var brand = document.createElement('div');
    brand.className = 'sidebar-brand';
    brand.innerHTML = '<img src="/assets/logo-badge-sm.png" alt="CSN" width="34" height="29" /><span class="sidebar-brand-name">CSN</span>';
    nav.appendChild(brand);
    links.forEach(function (l) {
      var a = document.createElement('a');
      a.href = l.href;
    ...
    langBtn.type = 'button';
    langBtn.innerHTML = '<span class="material-symbols-outlined">translate</span><span>Idioma</span>';
    langBtn.addEventListener('click', function () { var b = document.querySelector('[data-action="toggle-lang"]'); if (b) b.click(); });
    footer.appendChild(themeBtn);
    footer.appendChild(langBtn);
    nav.appendChild(footer);
    document.body.insertBefore(nav, document.body.firstChild);
